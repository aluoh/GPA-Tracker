...
class MainViewController: UIViewController, UIScrollViewDelegate {
    ...
    var semester5 = tempSemester()
    var semester6 = tempSemester()
    var semester7 = tempSemester()
    ...
    override func viewDidLoad() {
        ...
        semester4.classes = [Course(name: "CS1", weight: 3.0, grade: "A-", isIgnored: false),
                             Course(name: "CS2", weight: 3.0, grade: "C-", isIgnored: false),
                             Course(name: "CS3", weight: 3.0, grade: "A-", isIgnored: false)
        ]
        semester5.classes = [Course(name: "CS1", weight: 4.0, grade: "A-", isIgnored: false),
                             Course(name: "CS2", weight: 4.0, grade: "B-", isIgnored: false),
                             Course(name: "CS3", weight: 2.0, grade: "B+", isIgnored: false)
        ]
        
        semester6.classes = [Course(name: "CS1", weight: 3.0, grade: "B+", isIgnored: false),
                             Course(name: "CS2", weight: 3.0, grade: "C", isIgnored: false),
                             Course(name: "CS3", weight: 3.0, grade: "A", isIgnored: false)
        ]
        semester7.classes = [Course(name: "CS1", weight: 3.0, grade: "B", isIgnored: false),
        ...
        overallGPA.calcCumulativeGPA(semesters: [semester4, semester5, semester6, semester7]) // This updates the GPA before displaying it, GPA here should be 3.89
